...
try {
    ...
    error_log("Registration attempt - User data: " . print_r($userData, true));
    ...
    error_log("Registration attempt - Final user data: " . print_r($userData, true));
    ...
    if ($result['success']) {
        ...
        echo json_encode([
            ...
            'debug' => 'Auth register method failed'
        ]);
    }
